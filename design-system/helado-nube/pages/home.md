...
Cuatro ranuras de gotas SDF se activan por distancia de scroll descendente, con tamaño, posición, desfase y duración derivados de la semilla de la receta. La gota se separa mediante un cuello y un espacio transparente antes de caer; al subir no se crean gotas nuevas. El canvas sólo reserva altura transparente para ese recorrido, no bloquea interacción, queda entre contenido y navegación y se oculta al abrir menú o carrito.
